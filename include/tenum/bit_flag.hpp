...
#define TENUM_SERIALIZE_BIT_FLAG_SIGNATURE(type_m,tuples_m) \
  template< > \
  template< > \
  inline ::std::string \
...
#define TENUM_SERIALIZE_BIT_FLAG_DECLARATION(type_m,tuples_m) \
  TENUM_SERIALIZE_BIT_FLAG_SIGNATURE(type_m,tuples_m);

#define TENUM_SERIALIZE_BIT_FLAG_DEFINITION_EACH(_,type_m,tuple_m) \
...
#define TENUM_SERIALIZE_BIT_FLAG_DEFINITION(type_m,tuples_m) \
  TENUM_SERIALIZE_BIT_FLAG_SIGNATURE(type_m,tuples_m) { \
    ::std::ostringstream stream; \
    BOOST_PP_SEQ_FOR_EACH(TENUM_SERIALIZE_BIT_FLAG_DEFINITION_EACH,type_m,tuples_m) \
    \
...
#define TENUM_DESERIALIZE_BIT_FLAG_SIGNATURE(type_m,tuples_m) \
  template< > \
  template< > \
...
#define TENUM_DESERIALIZE_BIT_FLAG_DECLARATION(type_m,tuples_m) \
  TENUM_DESERIALIZE_BIT_FLAG_SIGNATURE(type_m,tuples_m);

#define TENUM_DESERIALIZE_BIT_FLAG_DEFINITION(type_m,tuples_m) \
  TENUM_DESERIALIZE_BIT_FLAG_SIGNATURE(type_m,tuples_m) { \
...
#define TENUM_BIT_FLAG_SERIALIZATION_DECLARATION(type_m,tuples_m) \
  namespace tenum { \
    ...
    TENUM_SERIALIZE_BIT_FLAG_DECLARATION(type_m,tuples_m) \
    TENUM_DESERIALIZE_BIT_FLAG_DECLARATION(type_m,tuples_m) \
  } \
  TENUM_STREAM_OPERATORS_DECLARATION(type_m)

#define TENUM_BIT_FLAG_SERIALIZATION_DEFINITION(type_m,tuples_m) \
  namespace tenum { \
    ...
    TENUM_SERIALIZE_BIT_FLAG_DEFINITION(type_m,tuples_m) \
    TENUM_DESERIALIZE_BIT_FLAG_DEFINITION(type_m,tuples_m) \
  } \
...
#define TENUM_BIT_FLAG_DEFINITION(type_m,tuples_m) \
